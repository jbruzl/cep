...
public interface SubscriptionService {
	...
	/**
	 * Unregisters event. If event is not present, nothings happens. 
	 * Warning: with unregistering event, all subscriptions will be lost! Unregister only when undeploying process!
	 *  
	 * @param code of event
	 */
	...
	/**
	 * Subscribe @{link CepUser} to event defined by code with defined contact type.
	 * 
	 * @param user subscribing to event
	 * @param code of event
	 * @param contactType 
	 */
	...
	/**
	 * Unsubscribe @{link CepUser} from event defined by code with defined contact type.
	 * 
	 * @param user to be unsubscribed
	 * @param code of event, if null user is unsubscribed from all events
	 * @param contactType, if null user is unsubscribed from event with all contacts
	 */
	public void unsubscribeUser(CepUser user, String code, ContactType contactType);
	
	/**
	 * Unsubscribe contact from event defined by code with defined contact type.
	 * 
	 * @param contact to be unsubscribed
	 * @param code of event, if null user is unsubscribed from all events
	 * @param contactType, if null user is unsubscribed from event with all contacts
	 */
	 ...
	 * 
	 * @param user subscribed by
	 * @param contactType, if null all types are returned
	 * @return list of event codes
	 */
	public List<String> getUserSubscriptions(CepUser user, ContactType contactType);
	
	/**
	 * Returns list of event codes subscribed by given contact and type.
	 * 
	 * @param contact subscribed by
	 * @param contactType, if null all types are returned
	 * @return list of event codes
	 */
	 ...
	 * 
	 * @param code of event, not null
	 * @param contactType, not null
