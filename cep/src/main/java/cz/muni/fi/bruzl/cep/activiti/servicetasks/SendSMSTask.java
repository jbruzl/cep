 ...
 * 
 */
package cz.muni.fi.bruzl.cep.activiti.servicetasks;
...
import cz.muni.fi.bruzl.cep.entities.MessageType;
...
public class SendSMSTask implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		if(messageType == null) {
			logger.error("Supplied unsupported variable: receivers. Quitting SendSMSTask with params: {}", message);
			return;
		}
